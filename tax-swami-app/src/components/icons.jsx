...
// Small decorative "spark" used as an accent on the How-it-works step
// illustrations - a four-point burst, hand-drawn to match the rest of the
// set rather than a filled star glyph.
...
// Used by the light/dark theme toggle - sun shown when dark mode is active
// (i.e. "tap to go light"), moon shown when light mode is active.
